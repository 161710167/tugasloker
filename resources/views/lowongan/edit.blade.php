		...
		<div class="col-md-12">
			<div class="panel panel-primary">
			  ...
			  <div class="panel-body">
			  	<form action="{{ route('lowongan.update',$k->id) }}" method="post" >
			  		<input name="_method" type="hidden" value="PATCH">
        			{{ csrf_field() }}
			  		<div class="form-group {{ $errors->has('nama_low') ? ' has-error' : '' }}">
			  			<label class="control-label">Nama Lowongan</label>	
			  			<input type="img" name="nama_low" value="{{ $k->nama_low }}" class="form-control"  required>
			  		...
			  		<div class="form-group {{ $errors->has('tgl_mulai') ? ' has-error' : '' }}">
			  			...
			  			<input type="text" name="tgl_mulai" value="{{ $k->tgl_mulai }}" class="form-control"  required>
			  		...
			  		<div class="form-group {{ $errors->has('lokasi') ? ' has-error' : '' }}">
			  			...
			  			<input type="text" name="lokasi" value="{{ $k->lokasi }}" class="form-control"  required>
			  		...
			  		<div class="form-group {{ $errors->has('gaji') ? ' has-error' : '' }}">
			  			...
			  			<input type="text" name="gaji" value="{{ $k->gaji }}" class="form-control"  required>
			  			@if ($errors->has('gaji'))
                            <span class="help-block">
			  		...
			  		<div class="form-group {{ $errors->has('deskripsi_iklan') ? ' has-error' : '' }}">
			  			...
			  			<input type="text" name="deskripsi_iklan" value="{{ $k->deskripsi_iklan }}" class="form-control"  required>
